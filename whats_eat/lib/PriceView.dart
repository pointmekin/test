...
class PriceView extends StatefulWidget {
  PriceView({Key key, this.title}) : super(key: key);
...
class _PriceViewState extends State<PriceView> {
  ...
  void getCategorizedFood() {
    ...
    print(temp);
    List<dynamic> tempList = temp.where((element) => element[1] == ModalRoute.of(context).settings.arguments).toList();
    print(tempList);
    setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Price Range", style: TextStyle( color: Colors.black),),
        elevation: 0,
      ),
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Text("Price: $category", style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold),),
                ],
              ),
            ),
            SizedBox(height: 10),
